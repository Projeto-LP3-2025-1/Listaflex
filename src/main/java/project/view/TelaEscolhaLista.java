...
import project.dao.ListCollaboratorDAO;
import project.dao.UserDAO;
import project.dao.UserListDAO;
import project.model.UserList;
...
public class TelaEscolhaLista extends JFrame {
    ...
    private void criarNovaLista() {
        ...
        JLabel lblNome = new JLabel("Nome da Lista:", SwingConstants.LEFT);
        lblNome.setForeground(TEXT_COLOR_DARK);
        panel.add(lblNome);
        panel.add(listNameField);
        JLabel lblTipo = new JLabel("Tipo de Lista:", SwingConstants.LEFT);
        lblTipo.setForeground(TEXT_COLOR_DARK);
        panel.add(lblTipo);
        panel.add(listTypeBox);

        Object[] options = {"Confirmar", "Cancelar"};

        // Cria o diálogo com botões customizados
    ...
    private void editarListaSelecionada() {
        ...
        // Criar painel customizado para edição
        ...
        listTypeBox.setEnabled(false); // Tipo não pode ser alterado
        listTypeBox.setBackground(Color.WHITE);
        listTypeBox.setForeground(TEXT_COLOR_DARK);
        listTypeBox.setBorder(BorderFactory.createLineBorder(BORDER_COLOR_NEUTRAL));
        ...
        // Ajustar UIManager para personalizar cores do JOptionPane (botões, fundo)
        ...
        // Resetar UIManager para evitar afetar outros diálogos
...
} // fim da classe TelaEscolhaLista
